...
(function (root, factory) {
  ...
  var IsaacSaveFile = (function () {
      ...
      Chunk.prototype._read = function () {
        ...
        switch (this.type) {
          ...
          case IsaacSaveFile.ChunkType.SPECIAL_SEED_COUNTERS:
            this.body = new SpecialSeedCountersChunk(
              this._io,
              this,
              this._root,
            );
        ...
        if (
          !(
            KaitaiStream.byteArrayCompare(
              this.magic,
              [73, 83, 65, 65, 67, 78, 71, 83, 65, 86, 69, 48, 57, 82, 32, 32],
            ) == 0
          )
        ) {
    ...
    var CutsceneCountersChunk = (IsaacSaveFile.CutsceneCountersChunk =
      (function () {
    ...
    var ChallengeCountersChunk = (IsaacSaveFile.ChallengeCountersChunk =
      (function () {
    ...
    var BestiaryCountersChunk = (IsaacSaveFile.BestiaryCountersChunk =
      (function () {
    ...
    var SpecialSeedCountersChunk = (IsaacSaveFile.SpecialSeedCountersChunk =
      (function () {
